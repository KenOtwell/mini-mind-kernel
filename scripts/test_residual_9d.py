...
Data now lives in mindcore (single source of truth) — generated by
mindcore/scripts/build_emotional_bases.py. See mindcore/ARCHITECTURE.md.
"""
import numpy as np
from sentence_transformers import SentenceTransformer

data = np.load(r'C:\Users\Ken\Projects\mindcore\mindcore\data\emotional_bases_9d.npz')
emotion_names = [e for e in list(data['_emotion_names']) if e != 'residual']
