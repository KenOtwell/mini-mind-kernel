"""
Emotional projection — 384d → 9d semagram.

Shared module: both Falcon (via Qdrant wrapper) and Progeny (via
harmonic buffers) use this for emotional basis projection. One
implementation, one truth for how emotional space is computed.

Projects sentence embeddings onto the 9-dimensional emotional space
defined by the Gram-Schmidt orthonormalized bases in emotional_bases_9d.npz.
...
_bases_path: Path = Path(__file__).resolve().parent / "data" / "emotional_bases_9d.npz"
